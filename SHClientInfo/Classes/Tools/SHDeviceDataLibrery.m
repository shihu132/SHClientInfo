...
@interface SHDeviceDataLibrery()

@property (nonatomic, assign) DiviceType iDevice;

@end

@implementation SHDeviceDataLibrery
#pragma mark - Public Method

+(instancetype)sharedLibrery {
    static SHDeviceDataLibrery *_librery;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _librery = [[SHDeviceDataLibrery alloc] init];
